...
const RestaurantCard = ({ resName, cuisines, rating, delivery }) => {
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        className="res-logo"
        src="https://b.zmtcdn.com/data/reviews_photos/fc7/941676a414d9e5522695caa36c1f6fc7_1644157453.jpg?fit=around|300:273&crop=300:273;*,*"
      ></img>
      <h3>{resName}</h3>
      <h4>{cuisines} </h4>
      <h4>{rating}star</h4>
      <h4>{delivery} minitues</h4>
    </div>
  );
};
const Body = () => {
        ...
        {resList.map((restaurant) => {
          return (
            <RestaurantCard
              ...
              delivery={restaurant.data.sla.deliveryTime}
            />
          );
        })}
      </div>
